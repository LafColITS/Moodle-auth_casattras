...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_configstoredfile(
        'auth_casattras/auth_logo',
        new lang_string('auth_casattras_auth_logo', 'auth_casattras'),
        new lang_string('auth_casattras_auth_logo_description', 'auth_casattras'),
        'logo',
        0,
        $opts
    ));
    ...
    // Hostname.
    $settings->add(new admin_setting_configtext(
        'auth_casattras/hostname',
        new lang_string('auth_casattras_hostname_key', 'auth_casattras'),
        new lang_string('auth_casattras_hostname', 'auth_casattras'),
        '',
        PARAM_RAW_TRIMMED
    ));
    ...
    // Base URI.
    $settings->add(new admin_setting_configtext(
        'auth_casattras/baseuri',
        new lang_string('auth_casattras_baseuri_key', 'auth_casattras'),
        new lang_string('auth_casattras_baseuri', 'auth_casattras'),
        '',
        PARAM_RAW_TRIMMED
    ));
    ...
    $settings->add(new admin_setting_configtext(
        ...
        new lang_string('auth_casattras_port', 'auth_casattras'),
        '',
        PARAM_INT
    ));
    ...
    $settings->add(new admin_setting_configselect(
        'auth_casattras/casversion',
        new lang_string('auth_casattras_casversion', 'auth_casattras'),
        new lang_string('auth_casattras_version', 'auth_casattras'),
        'CAS_VERSION_2_0',
        $casversions
    ));
    ...
    $settings->add(new admin_setting_configselect(
        'auth_casattras/proxycas',
        new lang_string('auth_casattras_proxycas_key', 'auth_casattras'),
        new lang_string('auth_casattras_proxycas', 'auth_casattras'),
        0,
        $yesno
    ));
    ...
    // Logout option.
    $settings->add(new admin_setting_configselect(
        'auth_casattras/logoutcas',
        new lang_string('auth_casattras_logoutcas_key', 'auth_casattras'),
        new lang_string('auth_casattras_logoutcas', 'auth_casattras'),
        0,
        $yesno
    ));
    ...
    // Multi-auth.
    $settings->add(new admin_setting_configselect(
        'auth_casattras/multiauth',
        new lang_string('auth_casattras_multiauth_key', 'auth_casattras'),
        new lang_string('auth_casattras_multiauth', 'auth_casattras'),
        0,
        $yesno
    ));
    ...
    // Server validation.
    $settings->add(new admin_setting_configselect(
        'auth_casattras/certificatecheck',
        new lang_string('auth_casattras_certificate_check_key', 'auth_casattras'),
        new lang_string('auth_casattras_certificate_check', 'auth_casattras'),
        0,
        $yesno
    ));
    ...
    $settings->add(new admin_setting_configfile(
        'auth_casattras/certificatepath',
    ...
    // Alt Logout URL.
    $settings->add(new admin_setting_configtext(
        'auth_casattras/logoutreturnurl',
        new lang_string('auth_casattras_logout_return_url_key', 'auth_casattras'),
        new lang_string('auth_casattras_logout_return_url', 'auth_casattras'),
        '',
        PARAM_URL
    ));
